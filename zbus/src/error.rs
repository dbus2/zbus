...
pub enum Error {
    ...
    NameTaken,
    /// Error returned when attempting to convert between different zbus types and concrete
    /// representations (typically generated by the [dbus_proxy](crate::dbus_proxy) macro).
    Conversion,
}
...
impl PartialEq for Error {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (Self::Conversion, Self::Conversion) => true,
            (_, _) => false,
        }
    }
}
...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Error::Conversion => write!(f, "Conversion failed"),
        }
    }
}
