use std::{
    borrow::BorrowMut, fmt::Display, os::unix::ffi::OsStrExt, path::PathBuf, process::Stdio,
};
...
impl Unixexec {
    ...
    pub fn new(path: PathBuf, arg0: Option<String>, args: Vec<String>) -> Self {
        Self { path, arg0, args }
    }
    ...
    pub(super) fn from_options(opts: std::collections::HashMap<&str, &str>) -> crate::Result<Self> {
        ...
        let arg0 = opts.get("argv0").map(|arg0| arg0.to_string());
