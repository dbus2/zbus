...
* Use [`connection::ConnectionBuilder`] and disable the `internal_executor` flag.
...
[`connection::ConnectionBuilder`]: https://docs.rs/zbus/3.0.0/zbus/struct.ConnectionBuilder.html
